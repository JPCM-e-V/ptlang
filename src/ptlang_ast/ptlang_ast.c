...
void ptlang_ast_exp_destroy(ptlang_ast_exp exp)
{
    ...
    case PTLANG_AST_EXP_STRUCT:
        ptlang_free(exp->content.struct_.type);
    ...
    case PTLANG_AST_EXP_STRUCT_MEMBER:
        ...
        ptlang_free(exp->content.struct_member.member_name);
        break;
